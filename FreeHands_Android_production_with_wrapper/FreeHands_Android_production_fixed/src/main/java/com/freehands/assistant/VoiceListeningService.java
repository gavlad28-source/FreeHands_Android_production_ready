...
public class VoiceListeningService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "VoiceListeningService created");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d(TAG, "Starting voice listening service");
    ...
    private void startContinuousListening() {
        ...
        audioProcessingExecutor.execute(() -> {
            try {
                ...
                Log.d(TAG, "Started continuous audio recording");
    ...
    private void onWakeWordTriggered() {
        ...
        Log.d(TAG, "Wake word triggered - starting command processing");
    ...
    private void startVoiceAuthentication() {
        authenticator.authenticateVoice(new VoiceBiometricAuthenticator.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded() {
                Log.d(TAG, "Voice authentication successful");
            ...
            public void onAuthenticationFailed(String reason) {
                ...
                // Log security event
                securityManager.logSecurityEvent("authentication_failed", "Voice authentication failed: " + reason);
    ...
    public void onDestroy() {
        Log.d(TAG, "VoiceListeningService destroyed");
